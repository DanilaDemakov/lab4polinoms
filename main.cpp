...
int main() {
    ...
    while (true) {
		system("cls");
        cout << "Введите номер полинома, который хотите поменять. Используйте формат, при вводе полинома:(12x^3y^2z^17+...)\n Для суммы (+) или умножения (*) введите соответствующий знак.\n";
        cout << " 1) ";
